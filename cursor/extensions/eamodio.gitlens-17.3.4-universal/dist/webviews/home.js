...
`;let GlObjectSelect=class GlObjectSelect extends GlElement{constructor(){super(...arguments),this.disabled=!1}static{this.styles=[lp]}render(){if(this.options)return ew`
		...
		`}};l_.styles=[o2,o8,o3,E``],lw([eT({type:Object})],l_.prototype,"badgeSource",2),lw([C({context:"state",subscribe:!0}),eL()],l_.prototype,"_state",2),l_=lw([eB("gl-feature-nav")],l_);let lk=E`
	:host {
